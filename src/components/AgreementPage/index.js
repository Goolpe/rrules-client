    	...
    	<section id="agreement">
	    	<div className="container">
		    	...
		    	<div className="shadow bg_card text_card p-5 w-100 m-auto">
		    		...
		    		<span>Voluptatibus voluptate odit quo libero ipsam maiores. Repellendus sunt, eius neque ipsa nulla rerum fuga, nobis. Cumque sapiente, assumenda ipsa recusandae. Officia magnam doloremque obcaecati ipsa ut, provident vel odio!</span></p>
		    	</div>
	    	</div>
    	</section>
    )
