	  ...
	  return (
	  	<main>	
	  		<section className="container text_card"> 
	            ...
	            <input type="text" value={this.state.picture} onChange={this.onChange} name="picture" className="form-control" placeholder="" />
	         	</div>
	         	<div className="form-group text-left">
	            <label>Фон*</label>
	            <input type="text" value={this.state.bgImage} onChange={this.onChange} name="bgImage" className="form-control" placeholder="" required />
	         	</div>
	          <div className="form-group text-left">
	          ...
	          <div className="form-group text-left">
	            <label>Теги</label>
	            <input type="text" value={this.state.hashtags} onChange={this.onChange} name="hashtags" className="form-control" placeholder="" />
	          </div>
