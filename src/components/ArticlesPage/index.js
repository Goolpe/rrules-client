...
class ArticlesPage extends Component {
  ...
  render() {
    ...
    const listItems = currentTodos.map(
      (article, index) =>
        <div className="container mb-3 p-0 text_card shadow article__background"
          style={ { backgroundImage: `url(${article.bgImage}` } } key={ index }
        >
