              ...
              <Row>
                <Col sm='12' className='text-dark'>
                  ...
                  <form onSubmit={this.handleSubmit} style={ { maxWidth: '400px', margin: 'auto' } }>
                    ...
                    <button className='btn btn-info mt-3 mb-3 w-100 p-3' type='submit'>
                      Создать аккаунт
                    </button>
                  </form>
              ...
              <Row>
                <Col sm='12' className='text-dark'>
                  ...
                  <p className='text-muted m-auto'
                    style={ { cursor: 'pointer' } }
                    onClick={ () => this.setState({ activeTab: 'forgot' }) }>Не могу войти
                  </p>
                  <p className='text-dark m-auto pt-3'
                    style={ { cursor: 'pointer' } }
                    onClick={ () => this.setState({ activeTab: 'soclogin' }) }>Нет аккаунта
                  </p>
                </Col>
              </Row>
            </TabPane>
